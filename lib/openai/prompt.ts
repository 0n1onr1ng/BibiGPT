...
视频字幕: "2.06 - 哈喽哈喽 这里是私密的频道 今天给大家介绍星赞AI总结  6.71 - 把哔哩哔哩的url贴进来  21.04 - 然后你就点击一键总结 稍等片刻 你就可以获得这样一份精简的总结`,
    output: `视频概述：星赞 AI 是一款自动总结视频内容的 AI 工具
只需要粘贴哔哩哔哩的URL，一键总结为精简内容`,
  }
}
