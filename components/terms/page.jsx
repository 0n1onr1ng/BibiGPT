        ...
        <>
            ...
            <div className='mt-24 px-4 lg:px-16 flex flex-col items-center justify-center'>
                <div className="prose">
                    ...
                    <p>
                        <b>Account</b> – means individualized panel serving the User to exploit the
                    ...
                    <p>
                        ...
                        the Guest, or the User publishes, presents or sends on the Website or with
                        the use of Service.
                    </p>
                    <p>
                        <b>Device</b> – means devices such as a computer, telephone, smartphone,
                        tablet or other electronic equipment which allows browsing web pages.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        smartphone, tablet or other electronic equipment which operates the Website
                        and/or the Service.
                    </p>
                    <p>
                        <b>Notification</b> – means message sent to the User as part of the Service.
                    </p>
                    <p>
                        <b>Other Websites</b> – means websites other than the Website.
                    </p>
                    <p>
                        <b>Password</b> – means the User’s anonymized verification tool which
                        enables the access to the Account and is the sequence of signs possibly to
                        entry by using the keyboard of the computer or Mobile Device, which also
                        allows entering text messages in the amount and configuration invented by
                        the User however containing at least 8 signs.
                    </p>
                    <p>
                    ...
                    <p>
                        Above mentioned definitions retain their meaning regardless of whether they
                        are expressed in the singular or the plural.
                    </p>
                    <h5>3. General Rules</h5>
                    <p>
                        Using the Service means full acceptance of the Terms. The Terms applies to
                        relations between the Company and the Guest or the User only. If the Service
                        and/or the Website introduces the possibility of providing services by other
                        entities, they will be provided on the basis of regulations shared by these
                        entities and only these entities will be responsible for the execution of
                    ...
                    <ul>
                        ...
                        <li>
                            allows the start-up of the one from following internet browsers: (i)
                            Google Chrome, (ii) Opera, (iii) Firefox, (iv) Safari, (v) Microsoft Edge,
                        </li>
                        <li>the internet browser version used cannot be older than one year,</li>
                        <li>has JavaScript enabled.</li>
                    </ul>
                    <p>
                        Using the API is possible if the following minimum technical requirements
                        are met:
                    </p>
                    <ul>
                        <li>has access to the Internet,</li>
                    ...
                    <p>
                        Using the Widget is possible if the following minimum technical requirements
                        are met:
                    </p>
                    <ul>
                        <li>has access to the Internet,</li>
                    ...
                    <p>
                        It is recommended to install anti-virus software on the Device or on the
                        Mobile Device.
                    </p>
                    <h5>4. Account</h5>
                    <p>
                        Account set-up is possible through the Website. Account set-up requires
                        logging in using Facebook account, Google account or registering by
                        providing other personal email and Password. When you create an Account you
                        should provide us with accurate, complete, and current information at all
                        ...
                        Device or Mobile Device and/or Account. You agree to accept responsibility
                        for any and all activities or actions that occur under your Account and/or
                        Password, whether your Password is with our Website and Service or a
                        third-party service. You must notify us immediately upon becoming aware of
                        any breach of security or unauthorized use of your Account. You may not use
                        as a username the name of another person or entity or that is not lawfully
                    ...
                    <p>
                        By creating an Account, you can agree to subscribe to newsletters, marketing
                        or promotional materials and other information we may send.{/* */}{" "}
                    </p>
                    <h5>6. Contests, Sweepstakes and Promotions</h5>
                    <p>
                        Any contests, sweepstakes or other promotions (collectively “Promotion(s)”)
                        made available through Service or Website may be governed by rules that are
                        separate from these Terms (in particular set out in the Agreement, if
                        concluded). If you participate in any Promotions, please review the
                        applicable rules as well as our Privacy Policy. If the rules for a Promotion
                        conflict with these Terms, Promotion rules will apply.
                    </p>
                    ...
                    <h5>10. Content</h5>
                    <p>
                        Our Service and Website allows you to post, link, store, share and otherwise
                        make available certain information, text, graphics, videos, or other
                        material (“Content”). You are responsible, in particular to your customers,
                        for Content that you post on or through Service including its legality,
                        reliability, and appropriateness. By posting Content on or through Service
                        or Website, You represent and warrant that: (i) Content is yours (you own
                        ...
                        entity. We reserve the right to terminate the Account of any User found to
                        be infringing on a copyright. You retain any and all of your rights to any
                        Content you submit, post or display on or through Service or Website and you
                        are responsible for protecting those rights. We take no responsibility and
                        assume no liability for Content you or any third party posts on or through
                        Service.
                    </p>
                    <h5>11. Prohibited Uses</h5>
                    <p>
                        You may use Service or Website only for lawful purposes and in accordance
                        with Terms. You agree not to use Service or Website:
                    </p>
                    <ul>
                        <li>
                    ...
                    <ul>
                        <li>
                            use Service and Website in any manner that could disable, overburden,
                            damage, or impair Service or Website or interfere with any other party’s
                            use of Service, including their ability to engage in real time activities
                            through Service or Website,
                        </li>
                        <li>
                            use any robot, spider, or other automatic device, process, or means to
                            access Service or Website for any purpose, including monitoring or copying
                            any of the material on Service or Website,
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            any parts of Service or Website, the server on which Service or Website is
                            stored, or any server, computer, or database connected to Service or
                            Website,
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        monitor the use of our Service and Website. This data is shared with other
                        Google services. Google may use the collected data to contextualise and
                        personalise the ads of its own advertising network. For more information on
                    ...
                    <p>
                        Mixpanel is provided by Mixpanel Inc. You can prevent Mixpanel from using
                    ...
                    <p>
                        ...
                        referred to in the Article 23 of the Act of February 4, 1994 on Copyright
                        and Related Rights. Upon purchase of a Subscription, the User receives the
                        Licence to use the Service in accordance with the Subscription. The Licence
                        is limited, non-transferable, revocable, non-exclusive and granted for a
                        period consistent with the conditions of the Subscription. The User is not
                        entitled to give a sublicense. The Licence is granted only in the following
                    ...
                    <p>
                        The User shall not modify, reverse engineer, decompile, disassemble or
                        attempt to derive source code from Service or the Website or any portion
                        thereof. The User is not entitled to create and/or publish APIs or otherwise
                        proxying access to the Service or the Website nor is allowed to use the
                        Service or the Website in an automated manner (that is by machine or
                        computer program).
                    </p>
                    <h5>14. Copyright Policy</h5>
                    <p>
                        We respect the intellectual property rights of others. It is our policy to
                        respond to any claim that Content posted with the use of the Service or on
                        the Website infringes on the copyright or other intellectual property rights
                        (“Infringement”) of any person or entity. If you are a copyright owner, or
                        ...
                        found on and/or through Service or Website on your copyright.
                    </p>
                    <h5>15. DMCA Notice and Procedure for Copyright Infringement Claims</h5>
                    <p>
                    ...
                    <p>
                        The Guest and/or User is fully liable for the consequences of authorised or
                    ...
                    <p>
                        ...
                        to a breach of Terms. If you wish to terminate your Account, you may simply
                        discontinue using Service. All provisions of Terms which, by their nature,
                    ...
                    <p>
                        ...
                        State of California without regard to its conflict of law provisions. Our
                    ...
                    <p>
                        ...
                        to the new terms, you are no longer authorized to use Service. In case of
                        any discrepancies between these Terms and the Agreement (if concluded), the
